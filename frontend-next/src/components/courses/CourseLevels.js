  ...
  return (
    ...
    >
      <div className="text-center py-8 lg:py-16">
        ...
        <p className="font-light text-gray-500 dark:text-gray-400 mb-4 sm:text-xl">
        ...
        <div className="flex flex-col mt-24 md:flex-row md:space-x-6">
          ...
          <Link
            ...
            className="flex flex-col items-center p-2 space-y-6 rounded-lg bg-veryLightGray hover:bg-veryPaleRed dark:bg-gray-700 dark:hover:bg-gray-600 md:w-1/3"
          >
