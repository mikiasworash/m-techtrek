  ...
  return (
    <div className="min-h-screen flex flex-col space-y-5 w-2/3 lg:w-1/2 mx-auto mt-16 lg:mt-20">
      <div className="text-center mx-auto flex flex-col space-y-4">
        ...
        <p>
          Our mission at our bootcamp is to empower individuals to achieve their
          full potential by providing high-quality education and training. We
          believe that everyone should have access to the tools and resources
          they need to succeed, and we're committed to providing a supportive
          and engaging learning environment that fosters growth, creativity, and
          collaboration.
        </p>
        <p>
          We believe in the power of education to transform lives and
          communities, and we're dedicated to providing the skills and knowledge
          that our students need to succeed in today's fast-paced and constantly
          evolving economy. Our goal is to help our students develop the
          critical thinking, problem-solving, and technical skills that are in
          high demand in a wide range of industries.
        </p>
        <p>
          We also believe in the importance of diversity, equity, and inclusion,
          and we're committed to creating an inclusive and welcoming learning
          environment for everyone. We believe that our differences are what
          make us strong, and we're dedicated to promoting diversity and
